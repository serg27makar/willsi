                                ...
                                <form className="form-request" action="#" method="post">
                                    <div className="form-request__row">
                                        <label className="form-request__label">
                                            <input className="form-request__input text-14" type="text" placeholder="Имя"/>
                                        ...
                                        <label className="form-request__label">
                                            <input className="form-request__input text-14" type="tel" placeholder="Телефон"/>
                                            <span className="form-request__icon">
                                    ...
                                    <button className="form-request__button-send text-18" type="button">{ru.SubmitApplication}</button>
                                </form>
                            </div>
                        </div>
                    </div>

...
class ServiceRed extends React.Component {
    ...
    render() {
        return(
            <div className="content">
                ...
                <div className="description-bg description-bg-red">
                    <div className="container">
                        <div className="row">
                            <div className="col-12 col-md-12 col-lg-12">
                ...
                <div className="partners partners-red">
                    <div className="container">
                        <div className="row">
                            <div className="col-12 col-md-12 col-lg-12">
                        ...
                        <div className="row align-items-start justify-content-center">
                            <div className="col-6 col-md-6 col-lg-3">
                                <div className="partners-env"><a className="partners-env__picture" href="#"
                                                                 target="_blank">
                                    <picture className="picture">
                ...
                <div className="reviews">
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="col-12 col-md-12 col-lg-12">
                                <div className="reviews-box reviews-red">

const ru = {
    ...
    hips: "Бедра - ",
    leg: "Нога - ",
    armGirth: "Обхват руки - ",
    thighGirth: "Обхват бедра - ",
    ...
    footCircumference: "Обхват объема стопы - ",
    neckGirth: "Обхват шеи - ",
    frontPawsLength: "Длина передних лап - ",
    ...
    allParametersAdded: "все параметры добавлены для этого пользователя",

        ...
        return(
            <div className="modal-envelope">
                ...
                <div className="modal-envelope__body">
                    <span className="add-store-label text-16 welcome-about-env">{ru.writeToSupport}</span>
                    <textarea className="form-shop__textarea text-14"
                              placeholder={ru.writeYourMessage} name="Message"
                              onChange={this.dataChange}/>
                    <div className="modal-form">
                        <div className="modal-form__button-enter">
                            <ButtonMain btnClass={"button-enter button-main text-18 medium"} text={ru.send} onClick={this.sendMessage}/>
                        </div>
                    </div>
                </div>
            </div>
